...
#start the measure
class AddIntervalScheduleFromFileCopy < OpenStudio::Ruleset::ModelUserScript

  #define the name that a user will see, this method may be deprecated as
  #the display name in PAT comes from the name field in measure.xml
  def name
    return "Add Interval Schedule From File Copy"
  end
...
AddIntervalScheduleFromFileCopy.new.registerWithApplication